...
class CloudEventAttributesMapperTest
{
   ...
   {
      // Bug 2: toCloudEventData(null) throws an obscure NullPointerException instead of a clear
      // IllegalArgumentException. Fix: add an explicit null-check at the top of toCloudEventData.
